...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center py-4 relative">
      ...
      <div className={`Menu   bg-brand-cell border border-brand-border-chip py-4  ${isOpen? "block":"hidden"} flex flex-col md:flex md:flex-row  items-center gap-4 md:gap-8  absolute top-full left-0 w-full md:relative md:top-0 md:w-auto`}>
